...
async def update_todo(user: user_dependency, db: db_dependency,
    ...
    todo = db.query(Todo).filter(Todo.id == todo_id).filter(user.get('id').first())
    if todo is None:
...
def create_todo_with_gemini(todo_string: str):
    ...
    response = llm.invoke(
        [
            HumanMessage(content="What i want you to do is to create a longer and more comprehensive description of that todo item, my next message will be my todo:"),
